                            ...
                            <div class="col-md-6">
                                <fieldset>
                                        ...
                                        <div class="col-md-6">
                                            <select id="parent" class="form-control @error('parent') is-invalid @enderror" name="parent"
                                                ...
                                                @foreach ($parents as $parent)
                                                    <option value="{{ $parent->id }}">{{ $parent->nomMenu }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="menu" id="menu" class="form-control @error('menu') is-invalid @enderror " required>
                                        </div>
                                        <div class="invalid-feedback">
                                            {{__('formulaire.Obligation')}}
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="lien" id="lien" class="form-control @error('lien') is-invalid @enderror " >
                                        </div>
                                        <div class="invalid-feedback">
                                            {{__('formulaire.Obligation')}}
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="icone" id="icone" class="form-control @error('lien') is-invalid @enderror " >
                                        </div>
                                        <div class="invalid-feedback">
                                            {{__('formulaire.Obligation')}}
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="number" name="ordre" id="ordre" class="form-control @error('lien') is-invalid @enderror " >
                                        </div>
                                        <div class="invalid-feedback">
                                            {{__('formulaire.Obligation')}}
                                        </div>
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            required autocomplete="action" multiple autofocus>
                                                <option value=""></option>
                                                @foreach ($actions as $action)
                                                    <option value="{{ $action->id }}">{{ $action->nomAction }}</option>
                                                @endforeach
                                            </select>
                                            <div class="invalid-feedback">
                                                {{__('formulaire.Obligation')}}
