        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header py-0">{{ __('Modifier ') }}{{$libelle}}</div>
                    <div class="card-body">
                        <form class="needs-validation" novalidate method="POST" action="{{ route('document.update', $documents->id) }}">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="col-md-6">
                                    ...
                                    value="{{ old('libelle') }}" required autofocus>
                                        ...
                                        @foreach ($typeDocuments as $typeDocument)
                                            <option value="{{$typeDocument->id}}" @if ($typeDocument->id==$documents->typeDocument_id) selected @endif> {{$typeDocument->libelle}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    value="{{ $documents->libelleDocument }}" required autofocus>
                                    <div class="invalid-feedback">
                                        {{__('formulaire.Obligation')}}
                                    </div>
