                        ...
                        <form class="needs-validation" novalidate method="POST" action="{{ route('action.update',$action->id) }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    value="{{ $action->nomAction }}" required autocomplete="action" autofocus>
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-6 offset-md-4">
                                    ...
                                    <a href="{{route('action.index')}}"><input type="button" id="annuler" value={{__('Annuler')}} class="btn btn-primary btnAnnuler"/></a>
                                </div>
                            </div>
                        </form>
                    </div>
